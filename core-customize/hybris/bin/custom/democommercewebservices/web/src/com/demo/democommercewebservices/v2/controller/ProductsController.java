 ...
 */
package com.demo.democommercewebservices.v2.controller;
...
import com.demo.democommercewebservices.constants.YcommercewebservicesConstants;
import com.demo.democommercewebservices.formatters.WsDateFormatter;
import com.demo.democommercewebservices.product.data.ReviewDataList;
import com.demo.democommercewebservices.product.data.SuggestionDataList;
import com.demo.democommercewebservices.queues.data.ProductExpressUpdateElementData;
import com.demo.democommercewebservices.queues.data.ProductExpressUpdateElementDataList;
import com.demo.democommercewebservices.queues.impl.ProductExpressUpdateQueue;
import com.demo.democommercewebservices.stock.CommerceStockFacade;
import com.demo.democommercewebservices.swagger.ApiBaseSiteIdParam;
import com.demo.democommercewebservices.v2.helper.ProductsHelper;
import com.demo.democommercewebservices.validator.PointOfServiceValidator;
...
public class ProductsController extends BaseController
{
	...
	/**
	 * Returns product's stock level
	 *
	 * @queryparam fields Response configuration (list of fields, which should be returned in response)
	 * @return Stock level information for product
	 * @throws WebserviceValidationException
	 *            If store doesn't exist
	 * @throws StockSystemException
	 *            When stock system is not enabled on this site
	 */
	@RequestMapping(value = "/{productCode}/stockdata", method = RequestMethod.GET)
	@ResponseBody
	public StockWsDTO getProductIsInStockOnline(final String baseSiteId, final String productCode,
			@RequestParam(defaultValue = DEFAULT_FIELD_SET) final String fields)
	{
		...
		{
			throw new ProductLowStockException("Product [" + sanitize(productCode) + "]  - out of stock online",
					LowStockException.NO_STOCK, productCode);
		}
		else
		{
			return getDataMapper().map(stock, StockWsDTO.class, fields);
		}
