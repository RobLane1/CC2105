...
public class DefaultSapphirefacadeService implements SapphirefacadeService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSapphirefacadeService.class);
	...
	{
		return DefaultSapphirefacadeService.class.getResourceAsStream("/sapphirefacade/sap-hybris-platform.png");
	}
