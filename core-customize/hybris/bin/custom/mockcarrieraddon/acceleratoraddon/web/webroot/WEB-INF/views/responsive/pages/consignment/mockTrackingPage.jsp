...
<link rel="stylesheet" href="/${contextPath}/_ui/addons/mockcarrieraddon/responsive/common/css/jquery.datetimepicker.css">
<script type="text/javascript" src="/${contextPath}/_ui/responsive/common/js/jquery-2.1.1.min.js"></script>
<script type="text/javascript" src="/${contextPath}/_ui/addons/mockcarrieraddon/responsive/common/js/jquery.datetimepicker.min.js"></script>
...
function madeAjaxCall(){
	 $.ajax({
	  ...
	  cache: false,    
	  data:'trackingId=' + $("#trackingId").val(),
	  success: function(response){
		  document.getElementById('consignment').style.display= 'block';
		  var obj = response; 
		   $('#result').html("Consignment Id:- " + obj.consignmentCode +"</br>Order Id:- " + obj.orderCode +"</br>Product SKU:- " + obj.sku  + "</br>Product Name:- " + obj.productName  + "</br>Price:- " + obj.price);
		  },
	  error: function(){      
...
<body>
	<img alt="logo" src="/${contextPath}/_ui/addons/mockcarrieraddon/responsive/common/images/logo-hybris-responsive.png" />
	<form:form method="post">
		...
		<table border="0" style="width:60%" cellpadding="5" cellspacing="5" align="center">
			...
			<tr>
				...
				<td align="left">
					<input id="trackingId" style="width:100%" type="text" name="trackingId" onblur="madeAjaxCall();"/>
				</td>
			</tr>
			<tr>
	...
	<h4 align="left">Consignment Details</h4>
	<table border="1" style="width:30%" cellpadding="5" cellspacing="5" align="left">
