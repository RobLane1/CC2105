			...
			<c:otherwise>
				<div class="form-group row carrier-info">
					<div class="col-sm-12 col-xs-12">
						...
						<a href="${trackingUrl}${consignment.trackingID}" target="_black"> 
				...
				<div class="form-group row status-info">
					<div class="col-sm-12 col-xs-12">
						<label>
							...
							<spring:message code="label.consignment.status" arguments="${consignment.trackingEvents[0].referenceCode}" />
						</label>
					</div>
					<div class="col-sm-12 col-xs-12">
						<span> 
