...
import de.hybris.platform.b2b.occ.v2.constants.Demob2boccaddonWebConstants;
import de.hybris.platform.b2b.occ.v2.errors.exceptions.PaymentAuthorizationException;
...
@ApiVersion("v2")
public class DemoB2BOrdersController
{
	 ...
	 */
	@Secured(
	{ Demob2boccaddonWebConstants.ROLE_CUSTOMERGROUP, Demob2boccaddonWebConstants.ROLE_GUEST,
			Demob2boccaddonWebConstants.ROLE_CUSTOMERMANAGERGROUP, Demob2boccaddonWebConstants.ROLE_TRUSTED_CLIENT })
	@RequestMapping(value = "/orders", method = RequestMethod.POST)
	@RequestMappingOverride(priorityProperty = "demob2bocc.B2BOrdersController.placeOrder.priority")
			...
			throws PaymentAuthorizationException, InvalidCartException
	{
		...
		placeOrderData.setTermsCheck(termsChecked == true ? Boolean.TRUE : Boolean.FALSE);
