...
<spring:htmlEscape defaultHtmlEscape="true" />
    ...
    <div class="row">
        <div class="container-lg col-md-6 col-md-offset-3">
                ...
                <div class="account-section-form">
                    ...
                    <form:form method="post" modelAttribute="supportTicketForm" enctype="multipart/form-data">
                        ...
                        <div id="Size-supportTicketForm-subject" class="help-block" style="display: none;"></div>
                   		<%-- 
                		<formElement:formInputBox idKey="createTicket-productId" labelKey="text.account.supporttickets.createTicket.product" path="productId" inputCSS="text" mandatory="true" />
                    	--%>	
						
						<div class="form-group">                    		
                    	<label class="control-label " for="createTicket-product">
                       	<spring:theme code="text.account.supporttickets.product" text="Product" />
                       	</label>
                       	<form:select id="productId" path="productId" class="form-control">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-sm-push-6 accountButtons">
                                        <ycommerce:testId code="supportTicket_create_button">
                                        	...
                                        	<c:otherwise>
                                        		<button class="btn btn-primary btn-block" disabled type="submit" id="addTicket">
	                                            <spring:theme code="text.account.supporttickets.createTicket.submit" text="Submit"/>
	                                            </button>
                                        	</c:otherwise>
                                        	</c:choose>
