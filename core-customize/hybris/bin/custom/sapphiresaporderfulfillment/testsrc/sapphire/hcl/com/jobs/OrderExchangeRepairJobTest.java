...
import sapphire.hcl.com.actions.SendOrderToDataHubAction;
...
public class OrderExchangeRepairJobTest
{
	...
	public void cronJobTest()
	{
		...
		when(
				orderExchangeRepair.findAllProcessModelsToRepair(SapphiresaporderfulfillmentConstants.ORDER_PROCESS_NAME,
						SendOrderToDataHubAction.ERROR_END_MESSAGE)).thenReturn(bpList);

		repairJob.perform(cronJobModel);
		verify(orderExchangeRepair).findAllProcessModelsToRepair(SapphiresaporderfulfillmentConstants.ORDER_PROCESS_NAME,
