...
import sapphire.hcl.com.constants.ActionIds;
import sapphire.hcl.com.constants.SapphiresaporderfulfillmentConstants;
...
public class OrderCancelRepairJob extends AbstractJobPerformable<CronJobModel>
{
	...
	private static final String YSAPORDERFULFILLMENT_REPAIR_JOB_CANCEL_MINUTES = "sapphiresaporderfulfillment.repair.job.cancel.minutes";
	...
	public PerformResult perform(final CronJobModel arg0)
	{
		...
		waitProcesses = orderExchangeRepair.findProcessesByActionIds(SapphiresaporderfulfillmentConstants.ORDER_PROCESS_NAME, new String[]
