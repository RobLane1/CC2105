...
/**
 * This ValueProvider will provide the product's promotion Description.
 */
public class SapphirePromotionDescriptionValueProvider extends PromotionCodeValueProvider
{
			...
			final IndexedProperty indexedProperty)
	{
		...
		if (baseSiteModel != null && baseSiteModel.getDefaultPromotionGroup() != null)
		{
			...
			if (defaultPromotionGroup != null)
			{
				...
				{
					addFieldValues(fieldValues, indexedProperty, null, getPromotionService().getPromotionDescription(promotion));
					break;
				}
			}
		}
