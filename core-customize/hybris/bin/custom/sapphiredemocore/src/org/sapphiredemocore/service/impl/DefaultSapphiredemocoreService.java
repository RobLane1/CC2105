...
public class DefaultSapphiredemocoreService implements SapphiredemocoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSapphiredemocoreService.class);
	...
	{
		return DefaultSapphiredemocoreService.class.getResourceAsStream("/sapphiredemocore/sap-hybris-platform.png");
	}
